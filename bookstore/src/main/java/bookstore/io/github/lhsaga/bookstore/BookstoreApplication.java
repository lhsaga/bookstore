...
public class BookstoreApplication {
	...
	public CommandLineRunner bookDemo(BookRepository repository) {
		return (args) -> {
			...
			repository.save(new Book("Rode Hard, Put Up Wet", " Lorelei James", "2007","9781599988368", 21.33));
			repository.save(new Book("Two in the Bush", "Gerald Durrell", "1966", "9780006345541", 18.99));
